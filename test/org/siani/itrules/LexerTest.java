...
public class LexerTest {
	...
	public void scapeCharacter() {
		String[] expectedTypes = new String[]{"RULE_BEGIN", "TYPE", "LEFT_P", "ID", "RIGHT_P", "NL", "SCAPED_CHAR", "TEXT", "SCAPED_CHAR", "TEXT", "RULE_END"};
	...
	public void MarkWithFormat() {
		String[] expectedTypes = new String[]{"RULE_BEGIN", "TYPE", "LEFT_P", "ID", "RIGHT_P",
			...
			"MARK_KEY", "ID", "OPTION", "FORMAT", "LEFT_P", "ID", "RIGHT_P", "TEXT", "RULE_END"};
