...
package org.siani.itrules.reader.reader;

import org.junit.Test;
import org.siani.itrules.Document;
import org.siani.itrules.JsonRulesReader;
...
public class AcceptedRuleEngine {
	...
	private static final String Template = "test.res/engine/templates/$case.itr.json";
    ...
    @Test
	public void should_render_frames_using_json_reader() throws Exception {
        for (String key : frames.keySet()) {
            System.out.println(key);
            Document document = new Document();
            RuleEngine ruleEngine = new RuleEngine(ruleSet(key));
            ruleEngine.render(frames.get(key), document);
    ...
    private RuleSet ruleSet(String name) throws FileNotFoundException {
        return JsonRulesReader.read(new FileInputStream(template(name)));
    }
