...
public final class FrameBuilder {
    ...
    private Context context() {
        return new Context() {
            ...
            @Override
            public Context slot(String name, Object object) {
            ...
            @Override
            public <S> void put(Class<S> aClass, Adapter<S> adapter) {
                FrameBuilder.this.put(aClass,adapter);
            }
        };
    }
    ...
    public interface Context {
        Context slot(String name, Object object);
        Frame build(Object value);

        <S> void put(Class<S> aClass, Adapter<S> adapter);
    }
