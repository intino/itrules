...
public class FrameBuilder_ {
    ...
    public void should_render_with_custom_adapter() {
        Frame frame = new FrameBuilder()
                .put(TwoAttributesObject.class, (source, context) -> context.slot("field1", context.build(source.getField1())))
    ...
    public void testAdaptersWithComplexFields() {
        Frame frame = new FrameBuilder()
                .put(ObjectWithList.class, (source, context) -> context.slot("object2", context.build(source.get(1))))
                .add(
                    new ObjectWithList(
